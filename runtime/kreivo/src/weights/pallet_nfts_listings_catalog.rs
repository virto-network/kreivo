//! Weights for `pallet_nfts` (instance `ListingsCatalog`).
//!
...
//! so the `ListingsCatalog` instance can be bound to this file. `/cmd bench --pallet pallet_nfts`
...
//! they belong to `ListingsCatalog`.
//!
