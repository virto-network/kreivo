...
//! Asset Hub Westend, copied from polkadot-sdk
//! (`cumulus/parachains/integration-tests/emulated/chains/parachains/assets/asset-hub-westend`,
//! `polkadot-stable2606-2`), which doesn't publish it. The bridge helpers are left out.
...
use emulated_integration_tests_common::{
	...
	impl_assets_helpers_for_system_parachain, impl_foreign_assets_helpers_for_parachain,
	impl_xcm_helpers_for_parachain, impls::Parachain, xcm_emulator::decl_test_parachains,
};
use frame_support::traits::OnInitialize;

use super::westend::Westend;
...
impl_foreign_assets_helpers_for_parachain!(AssetHubWestend, xcm::v5::Location, ForeignAssetReserveData);
