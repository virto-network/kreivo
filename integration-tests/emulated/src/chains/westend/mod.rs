...
//! The Westend relay chain, copied from polkadot-sdk
//! (`cumulus/parachains/integration-tests/emulated/chains/relays/westend`, `polkadot-stable2606-2`),
//! which doesn't publish it.
